...
gulp.watch( './src/js/*.js', gulp.task('bs-reload') ); //? ejsが更新されたらbs-relaodを実行
...
//! gulpコマンドで起動するタスク
gulp.task('default', gulp.series(gulp.parallel('browser-sync', 'watch','sass','ejs')));
